...
$prodatacol="prodata";
$taoxi="MJH_xiaotaoxi"; $taoxi="RTX_preciManagment";	$taoxi="RTX_preciPopulation";
$taocan="biaozhunban";	$taocan="jibingheji";			$taocan="ertongxiangmuheji";
$dirin||="./";
$dirout||="./";
